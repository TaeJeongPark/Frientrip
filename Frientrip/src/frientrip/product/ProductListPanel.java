...
import frientrip.main.MainFrame;
	...
	private ImageIcon img_productlisttitle;
	private ImageIcon img_productupdate;
	private ImageIcon img_productapply;
...
private void makeImageIcon() {
	...
	img_productlisttitle = new ImageIcon("Frientrip/img/product/img_productlisttitle.png");
	...
	img_productupdate = new ImageIcon("Frientrip/img/product/img_productupdate.png");
	img_productapply = new ImageIcon("Frientrip/img/product/img_productapply.png");
}
...
private void makeTitle() {
		...
		JLabel lblTitle = new JLabel(img_productlisttitle);
...
private void makeCenter() {
        ...
        JLabel lbl_guest = new JLabel("<html>홍길동 님의<br>선택한 상품보기</html>");
    	...
    	JButton btn_update = new JButton(img_productupdate);
    	JButton btn_apply = new JButton(img_productapply);
    	
    	btn_update.setBounds(85, 285, 138, 46);
    	panLeft.add(btn_update);
    	btn_apply.setBounds(85, 340, 138, 46);
    	panLeft.add(btn_apply);
